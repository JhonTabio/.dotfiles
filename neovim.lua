...
-- Update time (Such as diagnostics)
vim.opt.updatetime = 250

-- Mapped sequence wait time (Time between keymap commands)
...
require("lazy").setup({
	...
	{ "numToStr/Comment.nvim", opts = {} }, -- Same as require('Comment').setup({})

	-- Same as require('gitsigns').setup({ ... })
